...
public class GatewayMvcPropertiesBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    private final GatewayMvcPropertiesBeanDefinitionRegistrar.TrueNullOperationArgumentResolver trueNullOperationArgumentResolver = new GatewayMvcPropertiesBeanDefinitionRegistrar.TrueNullOperationArgumentResolver();
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        AbstractBeanDefinition routerFnProviderBeanDefinition = BeanDefinitionBuilder
                .genericBeanDefinition(GatewayMvcPropertiesBeanDefinitionRegistrar.RouterFunctionHolder.class, this::routerFunctionHolderSupplier)
                .getBeanDefinition();
        ...
        AbstractBeanDefinition routerFunctionBeanDefinition = BeanDefinitionBuilder
                .genericBeanDefinition(GatewayMvcPropertiesBeanDefinitionRegistrar.DelegatingRouterFunction.class).getBeanDefinition();
    ...
    static class DelegatingRouterFunction implements RouterFunction<ServerResponse> {
        ...
        final GatewayMvcPropertiesBeanDefinitionRegistrar.RouterFunctionHolder provider;

        DelegatingRouterFunction(GatewayMvcPropertiesBeanDefinitionRegistrar.RouterFunctionHolder provider) {
